...
let submit = ()=>{
    if (resume_builder.objective, resume_builder.name, resume_builder.address, resume_builder.email, resume_builder.desig, resume_builder.personal_details.father_name, resume_builder.personal_details.mother_name, resume_builder.declaration, resume_builder.phone, resume_builder.date_of_birth, resume_builder.personality, resume_builder.languages_known, resume_builder.skill, resume_builder.hobby, resume_builder.educational_qualification, resume_builder.project_details && resume_builder.experience_details) $("#submit").prop("disabled", false);
};
...
//# sourceMappingURL=index.f9d8abf9.js.map
